...
void load_dir_menu()
{
	...
	while (1)
	{
		...
		*temp = '\0';
		...
		while (cbm_k_chrin() != 0)
		{
		} // Read rest of entry until the end
		cbm_k_chrin();
		cbm_k_chrin();
	}
	cbm_k_clrch();
...
unsigned char unitNames[][11] = {
	/* 00 */ {0xa0, 0xaf, 0xa2},												 // APC
	/* 01 */ {0xb1, 0xa4, 0xa2, 0xae, 0xad},									 // Recon
	/* 02 */ {0xac, 0xa4, 0xa2, 0xa7},											 // Mech
	/* 03 */ {0xa8, 0xad, 0xa5, 0xa0, 0xad, 0xb3, 0xb1, 0xb8},					 // Infantry
	/* 04 */ {0xa0, 0xad, 0xb3, 0xa8, 0x1C, 0xa0, 0xa8, 0xb1},					 // Anti Air
	/* 05 */ {0xac, 0xa4, 0xa3, 0xa8, 0xb4, 0xac, 0x1C, 0xb3, 0xa0, 0xad, 0xaa}, // Medium Tank
	/* 06 */ {0xb2, 0xac, 0xa0, 0xab, 0xab, 0x1c, 0xb3, 0xa0, 0xad, 0xaa},		 // Small Tank
	/* 07 */ {0xac, 0xa8, 0xb2, 0xb2, 0xa8, 0xab, 0xa4, 0xb2},					 // Missiles
	...
	/* 15 */ {0xb2, 0xb4, 0xa1, 0xac, 0xa0, 0xb1, 0xa8, 0xad, 0xa4},			 // Submarine
